...
class EnsemblRestBase(EnsemblRest):
    ...
    def test_methodNotImplemented(self):
        ...
        self.EnsEMBL.__dict__["notImplemented"] = self.EnsEMBL.register_api_func(
            "notImplemented",
            ensemblrest.ensembl_config.ensembl_api_table
        )

        # Set __doc__ for generic class method
        self.EnsEMBL.__dict__["notImplemented"].__doc__ = ensemblrest.ensemblrest\
            .ensembl_api_table["notImplemented"]["doc"]
    ...
    def test_LDFeatureContainerAdaptor(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ld/human/pairwise/rs6792369/"""\
        ...
        # get a request
        self.EnsEMBL.getLdPairwise(species="human", id1="rs6792369", id2="rs1042779",
                                   population_name="1000GENOMES:phase_3:KHV", r2=0.85)
...
class EnsemblRestComparative(EnsemblRest):
    ...
    def test_getGeneTreeById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/genetree/id/ENSGT00390000003602?' """\
    ...
    def test_getGeneTreeMemberById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/genetree/member/id/"""\
        ...
        # Execute EnsemblRest function. Dealing with application/json is simpler,
        # since text/x-phyloxml+xml may change elements order
        test = self.EnsEMBL.getGeneTreeMemberById(id='ENSG00000157764', prune_species="cow", prune_taxon=9526,
                                                  content_type="application/json")
    ...
    def test_getGeneTreeMemberBySymbol(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/genetree/member/symbol/homo_sapiens/"""\
        ...
        # execute EnsemblRest function. Dealing with application/json is simpler,
        # since text/x-phyloxml+xml may change elements order
        test = self.EnsEMBL.getGeneTreeMemberBySymbol(species='human', symbol='BRCA2', prune_species="cow",
                                                      prune_taxon=9526, content_type="application/json")
    ...
    def test_getAlignmentByRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/alignment/region/taeniopygia_guttata/"""\
        ...
        # execute EnsemblRest function. Dealing with application/json is simpler
        test = self.EnsEMBL.getAlignmentByRegion(species="taeniopygia_guttata", region="2:106040000-106040050:1",
...
class EnsemblRestXref(EnsemblRest):
    ...
    def test_getXrefsBySymbol(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/xrefs/symbol/homo_sapiens/BRCA2?' """\
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestInfo(EnsemblRest):
    ...
    def test_getInfoComparaSpeciesSets(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/info/compara/species_sets/EPO?' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getInfoExternalDbs(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/info/external_dbs/homo_sapiens?' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getInfoVariationPopulations(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/info/variation/populations/homo_sapiens?filter=LD' """\
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestLinkage(EnsemblRest):
    ...
    def test_getLdId(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ld/human/rs1042779/1000GENOMES:phase_3:KHV?"""\
        ...
        # execute EnsemblRest function
        test = self.EnsEMBL.getLdId(species="human", id="rs1042779", population_name="1000GENOMES:phase_3:KHV",
                                    window_size=10, d_prime=1.0)
    ...
    def test_getLdPairwise(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ld/human/pairwise/rs6792369/rs1042779?"""\
    ...
    def test_getLdRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ld/human/region/6:25837556..25843455/"""\
        ...
        # execute EnsemblRest function
        test = self.EnsEMBL.getLdRegion(species="human", region="6:25837556..25843455",
                                        population_name="1000GENOMES:phase_3:KHV", r2=0.85, d_prime=1.0)
...
class EnsemblRestLookUp(EnsemblRest):
    ...
    def test_getLookupById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/lookup/id/ENSG00000157764?expand=1' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getLookupBySymbol(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/lookup/symbol/homo_sapiens/BRCA2?expand=1' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getLookupByMultipleSymbols_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/lookup/symbol/homo_sapiens?expand=1' """\
...
class EnsemblRestMapping(EnsemblRest):
    ...
    def test_getMapCdnaToRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/map/cdna/ENST00000288602/100..300?' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getMapCdsToRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/map/cds/ENST00000288602/1..1000?' """\
                   """-H 'Content-type:application/json'"""
    ...
    def test_getMapAssemblyOneToTwo(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/map/human/GRCh37/X:1000000..1000100:1/GRCh38?' """ \
                   """-H 'Content-type:application/json'"""
        ...
        # execute EnsemblRest function
        test = self.EnsEMBL.getMapAssemblyOneToTwo(species='human', asm_one='GRCh37', region='X:1000000..1000100:1',
                                                   asm_two='GRCh38')
    ...
    def test_getMapTranslationToRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/map/translation/ENSP00000288602/100..300?' """ \
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestOT(EnsemblRest):
    ...
    def test_getAncestorsById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ontology/ancestors/GO:0005667?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getAncestorsChartById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ontology/ancestors/chart/GO:0005667?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getDescendantsById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ontology/descendants/GO:0005667?' """ \
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestOverlap(EnsemblRest):
    ...
    def test_getOverlapById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/overlap/id/ENSG00000157764?feature=gene' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getOverlapByRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/overlap/region/human/7:140424943-140624564?feature=gene;""" \
    ...
    def test_getOverlapByTranslation(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/overlap/translation/ENSP00000288602?type=Superfamily' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getRegulatoryFeatureById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/regulatory/species/human/id/ENSR00000099113?' """ \
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestSequence(EnsemblRest):
    ...
    def test_getSequenceById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/sequence/id/CCDS5863.1?object_type=transcript;""" \
    ...
    def test_getSequenceByMultipleIds_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/sequence/id?mask=soft;expand_3prime=100' """ \
                   """-H 'Content-type:application/json' -H 'Accept:application/json' """ \
    ...
    def test_getSequenceByRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/sequence/region/human/X:1000000..1000100:1?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getSequenceByMultipleRegions_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/sequence/region/human?mask=soft;expand_3prime=100' """ \
...
class EnsemblRestHaplotype(EnsemblRest):
    ...
    def test_getTranscripsHaplotypes(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/transcript_haplotypes/homo_sapiens/ENST00000288602?' """ \
                   """-H 'Content-type:application/json'"""
...
class EnsemblRestVEP(EnsemblRest):
    ...
    def test_getVariantConsequencesByMultipleIds_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/vep/human/id?Blosum62=1;CSN=1' """ \
                   """-H 'Content-type:application/json' -H 'Accept:application/json' """ \
    ...
    def test_getVariantConsequencesByRegion(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/vep/human/region/9:22125503-22125502:1/C?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getVariantConsequencesByMultipleRegions_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/vep/homo_sapiens/region?Blosum62=1;CSN=1' """ \
...
class EnsemblRestVariation(EnsemblRest):
    ...
    def test_getVariationByMultipleIds_additional_arguments(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/variation/homo_sapiens?genotypes=1' """ \
                   """-H 'Content-type:application/json' -H 'Accept:application/json' """ \
                   """-X POST -d '{ "ids" : ["rs56116432", "COSM476" ] }'"""
...
class EnsemblRestVariationGA4GH(EnsemblRest):
    ...
    def test_getGA4GHDatasetById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ga4gh/datasets/6e340c4d1e333c7a676b1710d2e3953c?' """ \
                   """-H 'Content-type:application/json'"""
...
-H 'Accept:application/json' -X POST -d '{ "referenceSetId": "GRCh38", "pageSize": 10 }'"""
    ...
    def test_getGA4GHReferencesById(self):
        ...
        curl_cmd = """curl 'http://rest.ensembl.org/ga4gh/references/9489ae7581e14efcad134f02afafe26c?' """ \
                   """-H 'Content-type:application/json'"""
...
class EnsemblGenomeRest(unittest.TestCase):
    ...
    def test_getGeneFamilyById(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/family/id/MF_01120?compara=bacteria' -H """ \
    ...
    def test_getGeneFamilyMemberById(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/family/member/id/STK_01900?compara=bacteria' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getGeneFamilyMemberBySymbol(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/family/member/symbol/sulfolobus_tokodaii_str_7/""" \
                   """lysK?compara=bacteria' -H 'Content-type:application/json'"""

        # execute the curl cmd an get data as a dictionary
        reference = jsonFromCurl(curl_cmd)

        # execute EnsemblRest function
        test = self.EnsEMBL.getGeneFamilyMemberBySymbol(
            symbol="lysK",
            species="sulfolobus_tokodaii_str_7",
            compara="bacteria"
        )
    ...
    def test_getInfoGenomesByName(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/info/genomes/""" \
    ...
    def test_getInfoGenomesByAccession(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/info/genomes/accession/U00096?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getInfoGenomesByAssembly(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/info/genomes/assembly/GCA_000005845?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    def test_getInfoGenomesByDivision(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/info/genomes/division/EnsemblPlants?' """ \
                   """-H 'Content-type:application/json'"""
    ...
    # This test is commented due to ensemblgenomes.org consistently returning an error, even on their docummentation.
    # TODO: Check the link below and uncomment this, when it starts working.
    ...
    #
    #     curl_cmd = """curl 'http://rest.ensemblgenomes.org/info/genomes/taxonomy/Arabidopsis?' """ \
    #                """-H 'Content-type:application/json'"""
    #
    #     # execute the curl cmd an get data as a dictionary
    #     reference = jsonFromCurl(curl_cmd)
    ...
    def test_getLookupByGenomeName(self):
        ...
        curl_cmd = """curl 'http://rest.ensemblgenomes.org/lookup/genome/""" \
                   """campylobacter_jejuni_subsp_jejuni_bh_01_0142?' -H 'Content-type:application/json'"""
